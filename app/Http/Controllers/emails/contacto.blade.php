...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#229CD3" style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color: #333; width: 600px; margin: 0 auto; padding: 0;"><tr style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color: #333; margin: 0; padding: 0;"><td style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color: #333; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto; padding: 0;">&#13;
			&#13;
				<div style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color: #333; width: 600px; display: block; margin: 0 auto; padding: 0;">&#13;
					<table width="600" border="0" align="center" cellpadding="10" cellspacing="0" bgcolor="#229CD3" style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color: #333; width: 600px; margin: 0; padding: 0;"><tr style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color: #333; margin: 0; padding: 0;">
						...
						<img src="{{ URL::to('/') }}/img/logo-elec-mail.png" style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color: #333; max-width: 100%; margin: 0; padding: 10px;" alt="{{ Config::get('settings.sitename') }}" /></a></td>&#13;
...
&#13;
                       ...
                       <div style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color: #333; background-color: #E1E9EB; margin: 0 0 15px; padding: 15px;line-height: 1.4;">
                       	<h4 style="margin:0; padding:0 0 10px 0">{{ $elsubject }}</h4>
                       	&#13;
 						{{ $elmessage }}</div>
                         &#13;
                        </p>&#13;
